...
for i in range(no_of_random_samples):
    ...
    train_error_for_iters, test_error_for_iters = adc.fitPredictAndScore(train_data, train_result, test_data, test_result, calc_error_each_iter=True)
...
plotError(avg_train_error, 'Avg Train Error', 'Avg Train Error For '+str(no_of_random_samples)+' random splits and '+str(T)+' iterations')
plotError(avg_test_error, 'Avg Test Error', 'Avg Test Error For '+str(no_of_random_samples)+' random splits and '+str(T)+' iterations')
